...
/// Cross-language guarantee that Swift `extractStreams` matches the shared golden fixture on both
/// Swift and Kotlin (`StreamsParityTest.kt`). `streams_golden.json` is generated by `scripts/gen_golden.py`.

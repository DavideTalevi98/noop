...
class Backfiller(
    ...
    var sessionMotionRows = 0
        private set
    /**
     * #727: skin-temp samples banked this session. WHOOP 4.0 carries skin temp (and the raw SpO₂ channel)
     * ONLY in its full DSP sleep records; a strap banking HR/RR-only records reports 0 here even on a
     * healthy-looking sync — surfacing it makes "skin temp never appears" reports self-diagnosing. Mirrors
